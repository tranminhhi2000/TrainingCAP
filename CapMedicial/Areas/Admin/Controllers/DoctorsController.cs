...
namespace CapMedicial.Areas.Admin.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description,Department")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description,Department")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
